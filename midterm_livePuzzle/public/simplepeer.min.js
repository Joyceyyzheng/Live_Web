  ...
  return (function () {
  ...
  })()(
    {
        ...
        function (e, t, n) {
          ...
          function o(e) {
            ...
            return (
              2 === s &&
                ((t =
                  (u[e.charCodeAt(n)] << 2) | (u[e.charCodeAt(n + 1)] >> 4)),
                (l[c++] = 255 & t)),
              1 === s &&
                ((t =
                  (u[e.charCodeAt(n)] << 10) |
      ...
      3: [
        function (e, t, n) {
          (function (t) {
            ...
            function o(e, n, r) {
              ...
              if (null != a && a !== e) return t.from(a, n, r);
              var o = p(e);
              if (o) return o;
              if (
            ...
            function c(e) {
              for (
                var t = 0 > e.length ? 0 : 0 | f(e.length), n = a(t), r = 0;
                r < t;
                r += 1
              )
                n[r] = 255 & e[r];
            ...
            function b(e, n, r, a, o) {
              ...
              if (("string" == typeof n && (n = t.from(n, a)), t.isBuffer(n)))
                return 0 === n.length ? -1 : y(e, n, r, a, o);
              if ("number" == typeof n)
                return (
                  (n &= 255),
              ...
              for (var r = [], a = t; a < n; ) {
                ...
                if (a + s <= n) {
                  ...
                  1 === s
                    ...
                    ? ((l = e[a + 1]),
                      128 == (192 & l) &&
                        ((p = ((31 & o) << 6) | (63 & l)), 127 < p && (d = p)))
                    : 3 === s
                    ? ((l = e[a + 1]),
                      (c = e[a + 2]),
                      128 == (192 & l) &&
                        128 == (192 & c) &&
                        ((p = ((15 & o) << 12) | ((63 & l) << 6) | (63 & c)),
            ...
            function L(e) {
              ...
              for (var n = "", r = 0; r < t; )
                n += z.apply(String, e.slice(r, (r += 4096)));
              return n;
            }
            function A(e, t, n) {
              var r = "";
            ...
            function F(e, t, n, r, a) {
              return (
                (t = +t),
                (n >>>= 0),
                a || D(e, t, n, 4, 34028234663852886e22, -34028234663852886e22),
                $.write(e, t, n, r, 23, 4),
                n + 4
              );
            }
            function B(e, t, n, r, a) {
              return (
                ...
                (n >>>= 0),
                a ||
                  D(e, t, n, 8, 17976931348623157e292, -17976931348623157e292),
                $.write(e, t, n, r, 52, 8),
                n + 8
              );
            }
            ...
            var X = e("base64-js"),
              $ = e("ieee754");
            (n.Buffer = t), (n.SlowBuffer = g), (n.INSPECT_MAX_BYTES = 50);
            (n.kMaxLength = 2147483647),
              ...
              (t.compare = function (e, n) {
                if (
                  (G(e, Uint8Array) && (e = t.from(e, e.offset, e.byteLength)),
                  G(n, Uint8Array) && (n = t.from(n, n.offset, n.byteLength)),
                ...
                if (e === n) return 0;
                for (
                  var r = e.length, o = n.length, d = 0, s = K(r, o);
                  d < s;
                  ++d
                )
                  if (e[d] !== n[d]) {
              ...
              (t.concat = function (e, n) {
                ...
                for (r = 0; r < e.length; ++r) {
                  var d = e[r];
                  if ((G(d, Uint8Array) && (d = t.from(d)), !t.isBuffer(d)))
                    throw new TypeError(
                      '"list" argument must be an Array of Buffers'
                    );
                  d.copy(a, o), (o += d.length);
                }
                return a;
              }),
              (t.byteLength = h),
              ...
              (t.prototype.compare = function (e, n, r, a, o) {
                if (
                  (G(e, Uint8Array) && (e = t.from(e, e.offset, e.byteLength)),
                  !t.isBuffer(e))
                )
                ...
                if (
                  ...
                  0 > n || r > e.length || 0 > a || o > this.length)
                )
            ...
            (t.prototype.slice = function (e, n) {
              ...
              (t.prototype.copy = function (e, n, r, a) {
                ...
                if (
                  ...
                  for (var d = o - 1; 0 <= d; --d) e[d + n] = this[d + r];
                else Uint8Array.prototype.set.call(e, this.subarray(r, a), n);
                return o;
              }),
        ...
        { "base64-js": 1, buffer: 3, ieee754: 8 },
      ],
      4: [
        function (e, t, n) {
          (function (a) {
        ...
        function (e, t) {
          ...
          function a(e, t, n) {
            if (t) e.call(n);
              ...
              for (var r = e.length, a = m(e, r), o = 0; o < r; ++o)
                a[o].call(n);
          }
          function d(e, t, n, r) {
            if (t) e.call(n, r);
            else
              for (var a = e.length, o = m(e, a), d = 0; d < a; ++d)
                o[d].call(n, r);
          }
          function s(e, t, n, r, a) {
            if (t) e.call(n, r, a);
            else
              for (var o = e.length, d = m(e, o), s = 0; s < o; ++s)
                d[s].call(n, r, a);
          }
          function l(e, t, n, r, a, o) {
            if (t) e.call(n, r, a, o);
            else
              for (var d = e.length, s = m(e, d), l = 0; l < d; ++l)
                s[l].call(n, r, a, o);
          }
          function c(e, t, n, r) {
            if (t) e.apply(n, r);
            ...
            if (
              ...
              i
                ? (i.newListener &&
                    ...
                    (i = e._events)),
                  (d = i[t]))
                : ((i = e._events = y(null)), (e._eventsCount = 0)),
              !d)
            )
              ...
              ("function" == typeof d
                ...
                ? d.unshift(n)
                : d.push(n),
              !d.warned && ((o = r(e)), o && 0 < o && d.length > o))
            ) {
              d.warned = !0;
              var s = new Error(
          ...
          function _(e, t) {
            for (var r = t, a = r + 1, o = e.length; a < o; r += 1, a += 1)
              e[r] = e[a];
            e.pop();
          }
          function m(e, t) {
          ...
          R
            ...
            (n.prototype.emit = function (e) {
              var t,
                ...
                p,
                f = "error" === e;
              if (((p = this._events), p)) f = f && null == p.error;
              else if (!f) return !1;
              if (f) {
                if (
              ...
              switch (((r = arguments.length), r)) {
                case 1:
                  ...
                  break;
                case 2:
                  d(n, h, this, arguments[1]);
                  break;
                case 3:
                  s(n, h, this, arguments[1], arguments[2]);
                  break;
                case 4:
                  l(n, h, this, arguments[1], arguments[2], arguments[3]);
                  break;
                default:
                  for (o = Array(r - 1), u = 1; u < r; u++)
                    o[u - 1] = arguments[u];
                  c(n, h, this, o);
              }
              return !0;
        ...
        function (e, a, o) {
          (o.read = function (t, n, a, o, l) {
            var c,
              ...
              d = t[n + _];
            for (
              _ += b, c = d & ((1 << -h) - 1), d >>= -h, h += p;
              0 < h;
              c = 256 * c + t[n + _], _ += b, h -= 8
            );
            for (
              u = c & ((1 << -h) - 1), c >>= -h, h += o;
              0 < h;
              u = 256 * u + t[n + _], _ += b, h -= 8
            );
            if (0 === c) c = 1 - g;
            else {
              ...
              for (
                o = n(o),
                  isNaN(o) || o === 1 / 0
                    ...
                    : ((_ = t(h(o) / g)),
                      1 > o * (y = r(2, -_)) && (_--, (y *= 2)),
                      (o += 1 <= _ + R ? E / y : E * r(2, 1 - R)),
                      2 <= o * y && (_++, (y /= 2)),
                      _ + R >= w
                        ? ((b = 0), (_ = w))
                        : 1 <= _ + R
                        ? ((b = (o * y - 1) * r(2, p)), (_ += R))
                        : ((b = o * r(2, R - 1) * r(2, p)), (_ = 0)));
                8 <= p;
                a[l + S] = 255 & b, S += k, b /= 256, p -= 8
              );
              for (
                _ = (_ << p) | b, C += p;
                0 < C;
                a[l + S] = 255 & _, S += k, _ /= 256, C -= 8
              );
              a[l + S - k] |= 128 * d;
            });
        },
      ...
      16: [
        ...
        { "./_stream_transform": 18, inherits: 9 },
      ],
      17: [
        function (e, t) {
          (function (n, r) {
            ...
            function b(e, t) {
              for (
                ...
                var n = t.length;
                if ((x("maybeReadMore read 0"), e.read(0), n === t.length))
                  break;
              }
              t.readingMore = !1;
            }
            ...
            function R(e, t) {
              t.resumeScheduled ||
                ((t.resumeScheduled = !0), n.nextTick(E, e, t));
            }
            function E(e, t) {
              x("resume", t.reading),
                t.reading || e.read(0),
            ...
            function T(e) {
              ...
              x("endReadable", t.endEmitted),
                t.endEmitted || ((t.ended = !0), n.nextTick(v, t, e));
            }
            function v(e, t) {
              if (
            ...
            Object.defineProperty(s.prototype, "destroyed", {
              ...
              (s.prototype.setEncoding = function (t) {
                ...
                for (
                  var r = this._readableState.buffer.head, a = "";
                  null !== r;
            ...
            (s.prototype.read = function (e) {
              ...
              if (
                ...
                return (
                  ...
                  0 === t.length && t.ended ? T(this) : h(this),
                  null
                );
              ...
              (s.prototype.pipe = function (e, t) {
                  ...
                  x("dest.write", n),
                    !1 === n &&
                      (((1 === f.pipesCount && f.pipes === e) ||
                        ...
                        !m &&
                        (x("false write response, pause", f.awaitDrain),
                        f.awaitDrain++),
                      p.pause());
                }
                function s(t) {
                ...
                (f.pipesCount += 1),
                  x("pipe count=%d opts=%j", f.pipesCount, t);
                var g =
                    (!t || !1 !== t.end) && e !== n.stdout && e !== n.stderr,
                  h = g ? a : u;
                f.endEmitted ? n.nextTick(h) : p.once("end", h),
                  e.on("unpipe", r);
                var _ = y(p);
                e.on("drain", _);
                var m = !1;
              ...
              (s.prototype.on = function (e, t) {
                var r = M.prototype.on.call(this, e, t),
                ...
                return (
                  "data" === e
                    ...
                    : "readable" == e &&
                      ...
                      a.length ? h(this) : !a.reading && n.nextTick(w, this)),
                  r
                );
              }),
              (s.prototype.addListener = s.prototype.on),
              (s.prototype.removeListener = function (e, t) {
                var r = M.prototype.removeListener.call(this, e, t);
                return "readable" === e && n.nextTick(C, this), r;
              }),
              (s.prototype.removeAllListeners = function (e) {
                var t = M.prototype.removeAllListeners.apply(this, arguments);
                return (
              ...
              "function" == typeof Symbol &&
                (s.prototype[Symbol.asyncIterator] = function () {
                  return (
                    void 0 === O &&
                      (O = e("./internal/streams/async_iterator")),
                    O(this)
                  );
                }),
              ...
              "function" == typeof Symbol &&
                (s.from = function (t, n) {
                  return (
                    void 0 === U && (U = e("./internal/streams/from")),
                    U(s, t, n)
                  );
                });
          }).call(
      ...
      18: [
        ...
        { "../errors": 14, "./_stream_duplex": 15, inherits: 9 },
      ],
      19: [
        function (e, t) {
          (function (n, r) {
            ...
            function s(t, n, r) {
              (v = v || e("./_stream_duplex")),
                (t = t || {}),
                "boolean" != typeof r && (r = n instanceof v),
                (this.objectMode = !!t.objectMode),
                r &&
            ...
            function u(e, t, r, a) {
              ...
              return (
                null === r
                  ...
                  : "string" != typeof r &&
                    !t.objectMode &&
                    (o = new F("chunk", ["string", "Buffer"], r)),
                !o || (V(e, o), n.nextTick(a, o), !1)
              );
            }
            function p(e, t, n) {
              return (
            ...
            function m(e, t) {
              var r = e._writableState,
                a = r.sync,
                o = r.writecb;
              if ("function" != typeof o) throw new O();
              ...
              (l.prototype.write = function (e, t, n) {
                ...
                return (
                  ...
                  r.ending
                    ? c(this, n)
                    : (s || u(this, r, e, n)) &&
                      (r.pendingcb++, (a = f(this, r, s, e, t, n))),
                  a
                );
              }),
          ...
          (function (n) {
            ...
            function o(e) {
              ...
              if (null !== t) {
                var n = e[_].read();
                null !== n &&
                  ((e[g] = null), (e[c] = null), (e[u] = null), t(a(n, !1)));
              }
            }
            function i(e) {
              n.nextTick(o, e);
              ...
              return (
                ...
                l(e, function (e) {
                  if (e && "ERR_STREAM_PREMATURE_CLOSE" !== e.code) {
                    ...
                    return (
                      null !== t &&
                        ((n[g] = null), (n[c] = null), (n[u] = null), t(e)),
                      void (n[p] = e)
                    );
                  }
                  var r = n[c];
              ...
              d(e, [
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    for (
                      var t = u.allocUnsafe(e >>> 0), n = this.head, r = 0;
                      n;
      ...
      "/": [
        function (e, t) {
          (function (n) {
            ...
            /*! simple-peer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */ var i =
                e("debug")("simple-peer"),
              d = e("get-browser-rtc"),
              s = e("randombytes"),
              l = e("readable-stream"),
            ...
            class p extends l.Duplex {
              constructor(e) {
                ...
                (this._pcReady = !1),
                  ...
                  (this._isNegotiating = !this.negotiated && !this.initiator),
              ...
              _addIceCandidate(e) {
                ...
                this._pc.addIceCandidate(t).catch((e) => {
                  !t.address || t.address.endsWith(".local")
                    ? o("Ignoring unsupported ICE candidate.")
                    : this.destroy(a(e, "ERR_ADD_ICE_CANDIDATE"));
                });
              }
              send(e) {
              ...
              removeTrack(e, t) {
                ...
                try {
                  ...
                  "NS_ERROR_UNEXPECTED" === e.name
                    ...
                    : this.destroy(a(e, "ERR_REMOVE_TRACK"));
                }
                this._needsNegotiation();
              }
              removeStream(e) {
              ...
              _onConnectionStateChange() {
                this.destroyed ||
                  ("failed" === this._pc.connectionState &&
                    this.destroy(
                      a("Connection failed.", "ERR_CONNECTION_FAILURE")
                    ));
              }
              _onIceStateChange() {
                if (!this.destroyed) {
                  ...
                  this._debug(
                    ...
                    "closed" === e &&
                      this.destroy(
                        a("Ice connection closed.", "ERR_ICE_CONNECTION_CLOSED")
                      );
                }
              }
              getStats(e) {
